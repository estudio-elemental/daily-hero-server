...
class Hero(models.Model):
    ...
    max_hp = models.IntegerField(default=5, verbose_name="HP Máximo")
    hp = models.IntegerField(default=5, verbose_name="HP Atual")
    attack = models.IntegerField(default=3, verbose_name="Ataque")
    defense = models.IntegerField(default=1, verbose_name="Defesa")
